    ...
    <header class="sticky top-0 bg-white shadow-sm z-50">
        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
            ...
            <a
                ...
                class="text-xl font-light tracking-widest"
            >
                Shining Will
            </a>

            {{-- Navigation --}}
            <nav class="flex items-center gap-8 text-sm uppercase tracking-wider text-gray-700">
                ...
                <a
                    href="{{ route('store.home') }}#categories"
                    class="hover:text-pink-500 transition"
                >
                    CATEGORY
                </a>
                ...
                @auth
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="uppercase hover:text-pink-500 transition"
                        >
                            LOGOUT
                        </button>
